...
<p align="left">I'm a Software Engineer, currently focused on Golang, however, there are many technologies that I've used and some of them I'm using on a daily basis:<br><br>Go | Java | Amazon Web Services | Google Cloud Platform | SQL | Docker | Kubernetes | ElasticSearch (Kibana) | Shell Script | RabbitMQ | RFC | SOAP | REST | gRPC | CI/CD | Big Data tools</p>
